...
const (
	...
	retryMaxN = 3
	// Reply format
	replyText               = "<xml>%s<MsgType>text</MsgType><Content>%s</Content></xml>"
	replyImage              = "<xml>%s<MsgType>image</MsgType><Image><MediaId>%s</MediaId></Image></xml>"
	replyVoice              = "<xml>%s<MsgType>voice</MsgType><Voice><MediaId>%s</MediaId></Voice></xml>"
	replyVideo              = "<xml>%s<MsgType>video</MsgType><Video><MediaId>%s</MediaId><Title>%s</Title><Description>%s</Description></Video></xml>"
	replyMusic              = "<xml>%s<MsgType>music</MsgType><Music><Title>%s</Title><Description>%s</Description><MusicUrl>%s</MusicUrl><HQMusicUrl>%s</HQMusicUrl><ThumbMediaId>%s</ThumbMediaId></Music></xml>"
	replyNews               = "<xml>%s<MsgType>news</MsgType><ArticleCount>%d</ArticleCount><Articles>%s</Articles></xml>"
	replyHeader             = "<ToUserName>%s</ToUserName><FromUserName>%s</FromUserName><CreateTime>%d</CreateTime>"
	replyArticle            = "<item><Title>%s</Title> <Description>%s</Description><PicUrl>%s</PicUrl><Url>%s</Url></item>"
	transferCustomerService = "<xml>" + replyHeader + "<MsgType>transfer_customer_service</MsgType></xml>"
		...
		if err != nil {
			...
			if err != nil {
				...
				if err := json.Unmarshal(body, &res); err != nil {
					...
					return res.AccessToken, time.Duration(res.ExpiresIn + time.Now().Unix() - 200)
				}
			}
		}
	}
